...
describe('Consumer-Bridge-MultiService Relationship', function () {
    before(function () {
    ...
    it('should round-robin amongst available Services', function (done) {
        ...
        self.bridge.listenForServices(self.serviceUrl);
        self.bridge.listenForConsumers(self.consumerUrl);
        self.ok.connect(self.serviceUrl);
        self.notOk.connect(self.serviceUrl);
        self.consumer.connect(self.consumerUrl);

        self.consumer.emit('test', {
            answer: 42
