...
//
BroadcastHandler.prototype.connectForBroadcasts = connect
BroadcastHandler.prototype.connect = connect
...
function _handleBroadcasts() {
  ...
  messages.forEach(function (envelope) {
    ...
    debug('Receiving broadcast for %s with %s.', name, JSON.stringify(data))
